...
import javaTopics from "../../Questions/javaTopics";

const JavaLearning = () => {
  const [selectedTopic, setSelectedTopic] = useState(javaTopics[0]); // Default topic selected

  return (
    <div className="flex h-screen">
      {/* Left Sidebar: Topic List */}
      <div className="w-1/3 bg-white text-black p-6 overflow-y-auto">
        <h2 className="text-3xl font-bold text-red-700 mb-4">Java Learning</h2>
