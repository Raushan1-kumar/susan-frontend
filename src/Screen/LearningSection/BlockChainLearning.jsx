...
import blockchainTopics from "../../Questions/blockchain";

const BlockChainLearning = () => {
  const [selectedTopic, setSelectedTopic] = useState(blockchainTopics[0]); // Default topic selected
